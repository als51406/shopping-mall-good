...
const HomeBest: React.FC<Props> = ({ products = [], images = [], length = 4, title = '지금 가장 많이 담는 특가', containerWidth = '1000px', className = '' }) => {
  return (
    <div id="homeWrap" className={className}>
      <section className="products-section" style={{ width: containerWidth }}>
        <h2>
